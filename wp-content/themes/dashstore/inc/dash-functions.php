  ...
  <div id="options-sidebar">
    ...
    <div class="section">
		...
		<div class="support-links">
			<a href="http://docs.themes.zone/dash/" target="_blank" title="<?php esc_html_e('Read Theme Documentation', 'dashstore'); ?>"><i class="custom-icon-docs"></i><?php esc_html_e('Theme Documentation', 'dashstore'); ?></a>
			<span>&nbsp;|&nbsp;</span>
