...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => esc_html__( 'Use custom images output on Single product page?', 'dashstore' ),
		'desc' => esc_html__( 'Turning on custom image carousel on single product page', 'dashstore' ),
	...
	$options[] = array(
		'name' => esc_html__( 'Choose slider type for images on Single product page', 'dashstore' ),
		'id' => 'product_slider_type',
		'std' => 'slider-with-popup',
		'type' => 'select',
		'class' => 'hidden',
		'options' => array(
			'simple-slider'  => esc_html__('Slider', 'dashstore'),
			'slider-with-popup'  => esc_html__('Slider with pop-up gallery', 'dashstore'),
			'slider-with-thumbs'  => esc_html__('Slider with thumbnails', 'dashstore'),
			/*'vertical-thumbs'  => esc_html__('Vertical thumbnails', 'dashstore'),*/
		)
	);

	$options[] = array(
		'name' => esc_html__( 'Select transition effect for Product Images Carousel', 'dashstore' ),
